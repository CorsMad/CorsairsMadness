...
//draw_rectangle(16,24,32,42,0);
//draw_rectangle(38,24,54,42,0);
//draw_rectangle(60,24,76,42,0);
...
// Кнопка экипировать
if shown!= undefined && shown!= a_equip[equip.TRINKET] && shown!= a_equip[equip.ARMOR] && shown!= a_equip[equip.WEAPON]{    
