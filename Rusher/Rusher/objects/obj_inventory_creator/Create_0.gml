...
sword1   = new item_create_w("Sword1",   c_white  , 5  ,1.5,spr_info_sword1,10);
sword2   = new item_create_w("Sword2",   c_yellow , 8  ,1.2,spr_info_sword2,10);
sword3   = new item_create_w("Sword3",   c_white  , 10 ,1.1,spr_info_sword3,10);
armor1   = new item_create_a("Armor1",   c_white  , 10 ,spr_info_sword4,    10);
armor2   = new item_create_a("Armor2",   c_red    , 15 ,spr_info_sword5,    10);
trinket1 = new item_create_t("Trinket1", c_orange , 1.3,1.3,1,2,spr_info_sword6,10);
trinket2 = new item_create_t("Trinket2", c_orange , 1.3,1.4,1.6,1,spr_info_sword2,10);


trinket16 = new item_create_t("Trinket16", c_orange , 2,2,2,2,spr_info_sword1,10);
trinket17 = new item_create_t("Trinket17", c_orange , 3,2,2,2,spr_info_sword4,10);
