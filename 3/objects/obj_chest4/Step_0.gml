...
switch(a)
{
	...
	case 10:var k = instance_create_depth(x,y-16,-1,obj_money1);
			k.hspd = -18/20; break;
	case 15:var k = instance_create_depth(x,y-16,-1,obj_money1);
		   k.hspd = 18/20; break;
	case 20:var k = instance_create_depth(x,y-16,-1,obj_money1);
		   k.hspd = -16/20; break;
	case 25:var k = instance_create_depth(x,y-16,-1,obj_money1);
		   k.hspd = 16/20; break;
	case 30:var k = instance_create_depth(x,y-16,-1,obj_money1);
		   k.hspd = -14/20; break;
	case 35:var k = instance_create_depth(x,y-16,-1,obj_money1);
		   k.hspd = 14/20; break;
	case 40:var k = instance_create_depth(x,y-16,-1,obj_money10);
		  k.hspd =  -10/20; break;
	case 45:var k = instance_create_depth(x,y-16,-1,obj_money10);
		   k.hspd = 10/20; break;
