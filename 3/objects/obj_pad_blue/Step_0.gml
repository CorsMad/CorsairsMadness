...
if isOn = 1 && place_meeting(x,y,obj_Player) && obj_Player.key_jump_pressed && obj_Player.isAttackingdown = 0 && obj_Player.isClimbing = 0 && obj_Player.isHooking = 0 && obj_Player.isOutjump = 0 && obj_Player.isTakingdmg = 0
{
