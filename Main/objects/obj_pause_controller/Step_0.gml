...
switch(state){
    case 0:
        ...
        if delay = 0 && instance_exists(obj_Player) && isPaused = 0 && (keyboard_check_pressed(vk_escape) || gamepad_button_check_pressed(4,gp_start) || gamepad_button_check_pressed(0,gp_start)) && (obj_Player.isDead = 0 || obj_Player.isDead = 3) {
            fnc_snd_play_over(snd_pause_on);
            isPaused = 1;
			instance_deactivate_all(1);	
            instance_activate_object(obj_music_controller);
            instance_activate_object(DEBUG);
        ...
        if delay = 0 && instance_exists(obj_Player_boat) && isPaused = 0 && (keyboard_check_pressed(vk_escape) || gamepad_button_check_pressed(4,gp_start) || gamepad_button_check_pressed(0,gp_start)) && (obj_Player_boat.canControl = 1) {
            fnc_snd_play_over(snd_pause_on);
            isPaused = 1;
			instance_deactivate_all(1);		
            instance_activate_object(obj_music_controller);
    ...
    case 2: 
        ...
        if  delay = 0 && isPaused = 0 && (keyboard_check_pressed(vk_escape) || gamepad_button_check_pressed(4,gp_start) || gamepad_button_check_pressed(0,gp_start))  {
            fnc_snd_play_over(snd_pause_on);
            instance_deactivate_all(1);
            instance_activate_object(obj_music_controller);
            isPaused = 1;
