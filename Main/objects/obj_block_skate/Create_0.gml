...
{
    if !place_meeting(x-1,y,obj_block_skate) sprite_index = spr_snowsl_l_end;
    if !place_meeting(x+1,y,obj_block_skate) sprite_index = spr_snowsl_l_start;
    if (place_meeting(x+1,y,obj_block_skate) && place_meeting(x-1,y,obj_block_skate)) sprite_index = spr_snowsl_l_mid;
    /*
