...
draw_sprite_ext(spr_player_masked_superdash,-1,480-104,64,-1,1,0,c_white,alpha);
draw_sprite_ext(spr_superdash_stream3,-1,480-104,64,-1,1,0,c_white,alpha);
...
draw_text(room_width/2-80,40,text2);
draw_text(room_width/2-80,70,text4);
