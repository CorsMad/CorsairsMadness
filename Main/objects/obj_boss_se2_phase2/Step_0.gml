...
if t_anim = 5
{
    instance_create_depth(x+random_range(-10,10),y+random_range(-5,-30),depth+1,choose(obj_boss_se2_phase2_part1,obj_boss_se2_phase2_part2));
    t_anim = 0;   
}
#endregion
...
if enemy_hp <= 0
{
    instance_create_depth(x,y,0,obj_boss_se2_phase2_death)   ;
    instance_destroy();
}
#endregion
