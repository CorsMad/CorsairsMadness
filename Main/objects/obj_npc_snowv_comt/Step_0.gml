...
{
	if place_meeting(x,y,obj_Player) && talk_cr_t = 0 && obj_Player.canTalk = 1 && global.dia_snowComt != 0
    //if place_meeting(x,y,obj_Player) && global.dia_snowComt != 0 && 
	//talk_cr_t = 0 && obj_Player.isDead !=2 && obj_Player.key_up_press && 
	//obj_Player.isGrounded = 1 && obj_Player.isAttacking = 0 && 
    ...
    if talk_cr_t = 20
    {
        ...
        switch(global.dia_snowComt)
        {
            case 0.5: 
                ...
                break;
            case 1: instance_create_depth(x,y,-100000,obj_npc_junglev_comt_choose);  ; //2 разговор
                break;
