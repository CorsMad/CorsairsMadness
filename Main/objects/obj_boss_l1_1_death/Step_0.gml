...
switch(t)
{
    ...
    case 180:   
                instance_create_depth(x-24,y-24,depth-1,obj_sfx_explosion_bomb);
                instance_create_depth(x,y-24,depth-1,obj_sfx_explosion_bomb);
                instance_create_depth(x+24,y-24,depth-1,obj_sfx_explosion_bomb);
                instance_create_depth(x-24,y,depth-1,obj_sfx_explosion_bomb);
                ...
                instance_create_depth(x+24,y+24,depth-1,obj_sfx_explosion_bomb);
                break;
    case 190:   instance_create_depth(x,y,depth+1,obj_boss_l1_2_appear);break;
	case 210:	                
                var i1 = instance_create_depth(x-2,y-2,depth-1,obj_boss1_particle);
				i1.hspd = -0.5;
				i1.vspd = -2;
...
if point_distance(x, y, 240, 144) > 2
{
    move_towards_point(240, 144, 2);
}
else speed = 0;
