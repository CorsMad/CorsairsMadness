...
if talk_cr_t!= 0 
{
    ...
    {
        talk_cr_t = 0;
        if global.dia_shadowChief = 0 instance_create_depth(x,y,-100000,obj_txt_shadowv_npc1_1);
        if global.dia_shadowChief = 1 instance_create_depth(x,y,-100000,obj_txt_shadowv_npc1_2);
