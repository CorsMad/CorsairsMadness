...
if talk_cr_t > 1 
{
    ...
    if talk_cr_t = 20
    {
        ...
        {
            case 0:
                instance_create_depth(x,y,-100000,obj_npc_lavav_merch_choose); // Последующие разговоры
                break;
            case 1:
                switch(global.dia_vulcanoMerch_f_talk)
                {
                    case 0:
                        instance_create_depth(x,y,-100000,obj_txt_lavav_merch_f1);
                        break;
                    case 1:
                        instance_create_depth(x,y,-100000,obj_npc_lavav_merch_choose);
                        break;
                }
                break;
        }
