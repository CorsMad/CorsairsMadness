...
#region отрисовка карт
    draw_sprite_ext(spr_map_global,anim,240,135,GlobalMapxScale,GlobalMapyScale,0,c_white,GlobalMapAlpha);
...
#region отрисовка облаков
    draw_sprite_ext(spr_map_cloud_back,0,CloudLBackX,135,1,1,0,c_white,CloudLAlpha);
    draw_sprite_ext(spr_map_cloud_front,0,CloudLFrontX,135,1,1,0,c_white,CloudLAlpha);
    draw_sprite_ext(spr_map_cloud_back,0,CloudRBackX,135,-1,1,0,c_white,CloudLAlpha);
