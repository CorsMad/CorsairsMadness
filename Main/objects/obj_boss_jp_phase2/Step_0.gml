...
1.3 Удар по земле с выпадом и хитбокс летит

2. Дэш в сторону игрока

3. Хлопает в ладоши (вызов кольца и фонаря)

4. Выстрел из глаз по полукругу
...
if state = 0.2
{
    ...
    if t = 50
    {
        ...
        {
            case 1.1 :
                if (x >= 96 && x <= 384) state = choose(2,3,4);
                else state = choose(2,3);
                break;
            case 2 :
                if (x >= 96 && x <= 384) state = choose(1.1,3,4);
                else state = choose(1.1,3);
                break;
            case 3 :
                if (x >= 96 && x <= 384) state = choose(1.1,2,4);
                else state = choose(1.1,2);
                break;
            case 4 :
...
#region 1.1 Удар вперед с выпадом
...
#region 1.2 Удар по земле с выпадом 
...
#region 1.3 Удар по земле с выпадом и хитбокс летит
...
if state = 1.3
{
    ...
    {
        case 1:
            sprite_index = spr_follower_grounded_hand_attack3;
            image_index = 0;
            break;
        case 5:
            image_index = 1;
        ...
        case 40:
            ...
            break;
        case 50:
            instance_create_depth(x-34*image_xscale,y-14,depth-1,obj_boss_jp_handattack_vfx);
            image_index = 2;
            break;
        case 100:
            image_index = 4;
    ...
    {
        case 100:
            var ha3 = instance_create_depth(x,y,depth-1,obj_boss_jp_handattack3_vfx);
                ha3.hspd = image_xscale*8;
                ha3.image_xscale = image_xscale;
            hspd = 8*image_xscale;
            break;
            // Создание волны
        case 160:
...
#region 3. Хлопает в ладоши (вызов кольца и фонаря)
...
#region 4. Выстрел из глаз по полукругу
...
if state = 4
{
    ...
    switch(t_anim)
    {
        ...
        case 15:
            ...
            break;
        case 25:
            sprite_index = spr_follower_grounded_laser_green;
            image_index = 0;
        case 30:   
            image_index = 1;
            break;
...
{
    instance_destroy();
    d = instance_create_depth(x,y,depth,obj_boss_jp_death2);
