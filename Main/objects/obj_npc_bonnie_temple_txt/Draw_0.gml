...
scr_text_graphics();
draw_sprite(spr_text_icons,22,camera_get_view_x(view_camera[0])+6,camera_get_view_y(view_camera[0])+9);
...
draw_sprite(spr_text_icons,7,camera_get_view_x(view_camera[0])+6,camera_get_view_y(view_camera[0])+9);
