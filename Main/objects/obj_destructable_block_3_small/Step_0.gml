...
if place_meeting(x,y,obj_hitbox_mask) && hit_cd = 0
{
    ...
    instance_create_depth(x+8,y+24,depth-1,obj_sfx_dust_expl_small);
    instance_create_depth(x+24,y+24,depth-1,obj_sfx_dust_expl_small);
}
...
if hp <= 0 
{
    instance_create_depth(x+16,y+12,depth-1,obj_sfx_dust_expl_big);
    instance_destroy();   
}