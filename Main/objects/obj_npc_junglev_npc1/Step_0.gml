...
if talk_cr_t > 1 
{
    ...
    if talk_cr_t = 20
    {
        ...
        switch(global.dia_jungleChief){
            case 0: instance_create_depth(x,y,-100000,choose(obj_txt_junglev_npc1_11,obj_txt_junglev_npc1_12)); break;                         
            default:  
                switch(global.secrets_j1_s1){
                    case 0: // если еще не взял секрет
                                    switch(global.dia_jnpc){ // не говорил/говорил 1 раз
                                        case 0: instance_create_depth(x,y,-100000,obj_txt_junglev_npc1_2); break;                                                           
                                        case 1: instance_create_depth(x,y,-100000,obj_txt_junglev_npc1_3); break;                                                                                 
                                    }                       
                        break;
                    case 1: // если взял секрет
                                    switch(global.dia_jnpc){
                                        case 0: instance_create_depth(x,y,-100000,obj_txt_junglev_npc1_5); break;
                                        case 1: instance_create_depth(x,y,-100000,obj_txt_junglev_npc1_4); break;
                                        case 2: if global.completed_JF2 = 0 instance_create_depth(x,y,-100000,obj_txt_junglev_npc1_6); 
                                                else{                       instance_create_depth(x,y,-100000,obj_txt_junglev_npc1_7)}
                                                break;                                           
                                    } 
                        break;
                }           
...
if (global.dia_jungleChief) != 0 {   
    switch(global.secrets_j1_s1){
        case 0:
            if global.dia_jnpc = 0  qm.image_index = 1;
            if global.dia_jnpc = 1  qm.image_index = 2;
            break;
        case 1:
            if global.dia_jnpc = 2 qm.image_index = 0; else qm.image_index = 3;
            break;
    }                        
}
#endregion
