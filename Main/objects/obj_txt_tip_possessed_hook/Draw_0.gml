...
draw_sprite_ext(spr_tip_hook,-1,room_width/2-24,120,1,1,0,c_white,alpha);
draw_sprite_ext(spr_hook_block,-1,room_width/2-64,160,1,1,0,c_white,alpha);
...
draw_text(room_width/2,52,text2);
