...
#region state2
if instance_exists(obj_bossmerch_phase2_hand_l){
    draw_sprite_ext(spr_boss_hp_bar_bordersmall,0,(camera_get_view_x(view_camera[0]))+370,camera_get_view_y(view_camera[0])+2,1,1,0, c_white,1);
    draw_sprite_stretched(spr_boss_hp_barsmall,0,(camera_get_view_x(view_camera[0]))+373,camera_get_view_y(view_camera[0])+5,(obj_bossmerch_phase2_hand_l.enemy_hp/obj_bossmerch_phase2_hand_l.enemy_hp_max)*100,7);
}
if instance_exists(obj_bossmerch_phase2_hand_r){
    draw_sprite_ext(spr_boss_hp_bar_bordersmall,0,(camera_get_view_x(view_camera[0]))+370,camera_get_view_y(view_camera[0])+16,1,1,0, c_white,1);
    draw_sprite_stretched(spr_boss_hp_barsmall,0,(camera_get_view_x(view_camera[0]))+373,camera_get_view_y(view_camera[0])+19,(obj_bossmerch_phase2_hand_r.enemy_hp/obj_bossmerch_phase2_hand_r.enemy_hp_max)*100,7);
}
#endregion
...
if instance_exists(obj_bossmerch_phase3){
    draw_sprite_ext(spr_boss_hp_bar_border,0,(camera_get_view_x(view_camera[0]))+370,camera_get_view_y(view_camera[0])+3,1,1,0, c_white,1);
    draw_sprite_stretched(spr_boss_hp_bar,0,(camera_get_view_x(view_camera[0]))+373,camera_get_view_y(view_camera[0])+6,(obj_bossmerch_phase3.enemy_hp/obj_bossmerch_phase3.enemy_hp_max)*100,18);
}
#endregion
