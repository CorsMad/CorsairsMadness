...
#region enemy_hp
	...
	{
		for (var i=1; i-1<obj_boss_g2_phase1.enemy_hp; i++) 
		{
	...
	if instance_exists(obj_boss_g2_phase2)
	{
		for (var i=1; i-1<obj_boss_g2_phase2.enemy_hp; i++) 
		{
			draw_sprite_ext(spr_hud_boss_hp,1,(camera_get_view_x(view_camera[0])+460)-i*9,camera_get_view_y(view_camera[0])+16,1,1,0, c_white,1);
		}
	}

	if instance_exists(obj_boss_g2_phase3)
	{
		for (var i=1; i-1<obj_boss_g2_phase3.enemy_hp; i++) 
		{
			draw_sprite_ext(spr_hud_boss_hp,1,(camera_get_view_x(view_camera[0])+460)-i*9,camera_get_view_y(view_camera[0])+16,1,1,0, c_white,1);
		}
	}
