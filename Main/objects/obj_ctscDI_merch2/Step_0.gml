...
switch(state){
    ...
    case 1:
        ...
        if t = 50{
            t = 0;
            state = 1.5;
            instance_create_depth(x,y,0,obj_txt_DI_p2_end_merch1)
        }
        break;
    case 2:
        t++;
        if t = 10 {
            t = 0;
            instance_create_depth(x,y,0,obj_txt_DI_p2_end_jake);
            state = 3;
        }
        break;
    case 3:
    ...
    case 4:
        ...
        if t = 10{
            t = 0;
            state = 5;
            instance_create_depth(x,y,0,obj_txt_DI_p2_end_merch2);
        }
        break;
    case 6:
        t++;
