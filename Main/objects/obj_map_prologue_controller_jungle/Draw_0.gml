...
/////////КЛЮЧИ/////////
if global.key_green1 = 0 draw_sprite(spr_hud_key_sq,0,22,54) else draw_sprite(spr_hud_key_sq,1,22,54);
if global.key_green2 = 0 draw_sprite(spr_hud_key_tri,0,46,54) else draw_sprite(spr_hud_key_tri,1,46,54);
...
switch(globalMapCounter) // Секреты
        {
            ...
            case 1: // Колизей
                ...
                draw_text(40,27,string(global.secrets_j2_endurance) + "/1");
                break;  
            case 2: // 1 уровень
                draw_sprite(spr_hud_secret_big,0,22,32);
                draw_text(40,27,string(global.secrets_j1_r16 + global.secrets_j1_r5 + global.secrets_j1_s1) + "/3");
                break;  
            case 3: // 2 уровень
                draw_sprite(spr_hud_secret_big,0,22,32);
                draw_text(40,27,string(global.secrets_j2_s1 + global.secrets_j2p_r4 + global.secrets_J2b_s1) + "/3");
                break;                   
            case 5: // 
                draw_sprite(spr_map_global_follower_jngl,global.completed_JF2,72,54);
                break;   
        }    
