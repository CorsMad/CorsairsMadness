...
if isOn = 1
{
	...
	if t = t_max 
	{
		...
		if instance_exists(obj_block_series2)
		{
			obj_block_series2.isOn = 0;
			obj_block_series2.t = 0;
		}
		if instance_exists(obj_block_series3)
		{
			obj_block_series3.isOn = 0;
			obj_block_series3.t = 0;
		}
	}
}
