...
if state = 1
{
    ...
    if t1 = 40  
	{
		var st1 = instance_create_depth(x,y,depth-1,obj_sfx_snow_boss1_steam_ph1);
        st1.fol = id;
        t1 = 0;
	}
...
{
    var i = instance_create_depth(x,y+32,depth-1,obj_sfx4);
}
...
if t_red !=0 {t_red+=1;image_blend = c_red;}
...
if enemy_hp <= 0
{
    instance_create_depth(x,y,depth,obj_boss_s1_phase1_death)   
    instance_destroy();
}
#endregion