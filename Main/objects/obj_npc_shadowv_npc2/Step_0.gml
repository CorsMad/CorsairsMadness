...
if talk = 0
{
    ...
    {
        image_xscale = 1;
        sprite_index = spr_shadow_npc1_walk;
        prest = 0;
        spd = -0.5;
        t++;
        if t = 120
    ...
    if state = 1
    {
        sprite_index = spr_shadow_npc1_idle;
        spd = 0;
        t++;
        if t = 200
        {
...
if talk_cr_t!= 0 
{
    ...
    {
        talk_cr_t = 0;
        if global.dia_shadowChief = 0 instance_create_depth(x,y,-100000,obj_txt_shadowv_npc2_1);
        if global.dia_shadowChief = 1 instance_create_depth(x,y,-100000,obj_txt_shadowv_npc2_2);
