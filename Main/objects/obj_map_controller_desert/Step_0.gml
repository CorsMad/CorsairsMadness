    ...
    if Opened = 1 && global.completed_PD1 = 0
    {
        switch(globalMapCounter)
        {
            ...
            case 3: if key_right_press   {fnc_snd_play_over(snd_menu_select);globalMapCounter = 2};
                    if key_up_press      {fnc_snd_play_over(snd_menu_select);globalMapCounter = 4};
                    break;             
            case 4: if key_left_press    {fnc_snd_play_over(snd_menu_select);globalMapCounter = 3};
                    if key_down_pressed  {fnc_snd_play_over(snd_menu_select);globalMapCounter = 2};
    ...
    if Opened = 1 && global.completed_PD1 = 1 && global.completed_PD2 = 0
    {
        switch(globalMapCounter)
        {
            ...
            case 3: if key_right_press     {fnc_snd_play_over(snd_menu_select);globalMapCounter = 2};
                    if key_up_press        {fnc_snd_play_over(snd_menu_select);globalMapCounter = 5};
                    break;              
            case 5: if key_left_press      {fnc_snd_play_over(snd_menu_select);globalMapCounter = 3};
                    if key_down_pressed    {fnc_snd_play_over(snd_menu_select);globalMapCounter = 2};
                    if key_right_press     {fnc_snd_play_over(snd_menu_select);globalMapCounter = 1};
                    break;
        }
