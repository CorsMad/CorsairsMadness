...
if key_jump_pressed || key_attack // accept
{
    switch(submenu)
    {
        ...
        case 1: // Человек          
            switch(index)
            {
                case 0: // Покупка якорей
                    switch(dindex)
                    {
                        case 0: // 1-й якорь   
                            ...
                            break;
                        case 1: // 2-й якорь   
                            if (global.purch_anch2 = 0 && global.shop_axe_can_upgrade1 = 1 && global.gold >= 500 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 1)) {fnc_snd_play_over(snd_menu_accept);buy_confirm = 1;buy_confirm_yesno = 1;delay = 1;}
                            break;
                        case 2: // 3-й якорь   
                            if (global.purch_anch3 = 0 && global.shop_axe_can_upgrade2 = 1 && global.gold >= 750 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava >= 2)) {fnc_snd_play_over(snd_menu_accept);buy_confirm = 1;buy_confirm_yesno = 1;delay = 1;}
                            break;
                    }
                    break;
                case 1: // Покупка Бомб
                    ...
                    {
                        case 0: // 1-й якорь   
                            if (global.purch_bomb1 = 0 && global.gold >= 250) {fnc_snd_play_over(snd_menu_accept);buy_confirm = 1;buy_confirm_yesno = 1;delay = 1;}
                            break;
                        case 1: // 2-й якорь   
                            if (global.purch_bomb2 = 0 && global.shop_bomb_can_upgrade1 = 1 && global.gold >= 500 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 1)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 2: // 3-й якорь   
                            if (global.purch_bomb3 = 0 && global.shop_bomb_can_upgrade2 = 1 && global.gold >= 750 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 2)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                    }
                    break;
                case 2: // Покупка sparkle
                    ...
                    {
                        case 0: // 1-й якорь   
                            if (global.purch_sparkle1 = 0 && global.gold >= 250) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 1: // 2-й якорь   
                            if (global.purch_sparkle2 = 0 && global.shop_sparkle_can_upgrade1 = 1 && global.gold >= 500 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 1)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 2: // 3-й якорь   
                            if (global.purch_sparkle3 = 0 && global.shop_sparkle_can_upgrade2 = 1 && global.gold >= 750 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 2)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                    }
                    break;
                case 3: // Покупка попугая
                    ...
                    {
                        case 0: // 1-й якорь   
                            if (global.purch_eparrot1 = 0 && global.gold >= 250) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 1: // 2-й якорь   
                            if (global.purch_eparrot2 = 0 && global.shop_eparrot_can_upgrade1 = 1 && global.gold >= 500 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 1)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 2: // 3-й якорь   
                            if (global.purch_eparrot3 = 0 && global.shop_eparrot_can_upgrade2 = 1 && global.gold >= 750 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 2)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                    }
                    break;
        ...
        case 2: // Одержимый
            ...
            {
                case 0: // horizontal1
                    if (global.superattack1 = 0 && global.darkessence >= 1000) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                    break;
                case 1: // horizontal2
                    if (global.superattack1 = 1 && global.darkessence >= 2000) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                    break;
                case 2: // aoe
                    if (global.superattack2 = 0 && global.darkessence >= 2000) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                    break;
                case 3: // missle
                    if (global.superattack3 = 0 && global.darkessence >= 2000) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                    break;
                case 4:
                    fnc_snd_play_over(snd_menu_accept);
                    submenu = 0;
        ...
        case 3: // Лодка
            switch(index)
            {
                case 0:
                    ...
                    {
                        case 0: // 1-й якорь   
                            if (global.purch_rapidfire1 = 0 && global.gold >= 250) {fnc_snd_play_over(snd_menu_accept);buy_confirm = 1;buy_confirm_yesno = 1;delay = 1;}
                            break;
                        case 1: // 2-й якорь   
                            if (global.purch_rapidfire2 = 0 && global.shop_rapidfire_can_upgrade1 = 1 && global.gold >= 500 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 1)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 2: // 3-й якорь   
                            if (global.purch_rapidfire3 = 0 && global.shop_rapidfire_can_upgrade2 = 1 && global.gold >= 750 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 2)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                    }
                    break;
                case 1:
                    ...
                    {
                        case 0: // 1-й якорь   
                            if (global.purch_dualpistols1 = 0 && global.gold >= 250) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 1: // 2-й якорь   
                            if (global.purch_dualpistols2 = 0 && global.shop_dualpistols_can_upgrade1 = 1 && global.gold >= 500 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 1)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 2: // 3-й якорь   
                            if (global.purch_dualpistols3 = 0 && global.shop_dualpistols_can_upgrade2 = 1 && global.gold >= 750 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 2)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                    }
                    break;
                case 2:
                    ...
                    {
                        case 0: // 1-й якорь   
                            if (global.purch_blunderbuss1 = 0 && global.gold >= 250) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 1: // 2-й якорь   
                            if (global.purch_blunderbuss2 = 0 && global.shop_blunderbuss_can_upgrade1 = 1 && global.gold >= 500 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 1)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 2: // 3-й якорь   
                            if (global.purch_blunderbuss3 = 0 && global.shop_blunderbuss_can_upgrade2 = 1 && global.gold >= 750 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 2)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                    }
                    break;    
                case 3:
                    ...
                    {
                        case 0: // 1-й якорь   
                            if (global.purch_parrotcage1 = 0 && global.gold >= 250) {fnc_snd_play_over(snd_menu_accept);buy_confirm = 1;buy_confirm_yesno = 1;delay = 1;}
                            break;
                        case 1: // 2-й якорь   
                            if (global.purch_parrotcage2 = 0 && global.shop_parrotcage_can_upgrade1 = 1 && global.gold >= 500 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 1)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                        case 2: // 3-й якорь   
                            if (global.purch_parrotcage3 = 0 && global.shop_parrotcage_can_upgrade2 = 1 && global.gold >= 750 && (global.completedJungle + global.completedDesert + global.completedSnow + global.completedShadow + global.completedLava>= 2)) {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                            break;
                    }
                    break;    
                case 4:
        ...
        case 4: // jade
            ...
            {
                case 0:
                    if global.secrets >= price_hp {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                    break;
                case 1:
                    if global.secrets >= 3 {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                    break;
                case 2:
                    if global.hp_max > 5+global.hp_add {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                    break;
                case 3:
                    if global.mana_max > 3+global.mana_add {fnc_snd_play_over(snd_menu_accept);buy_confirm_yesno = 1;buy_confirm = 1;delay = 1;}
                    break;
                case 4:
                    fnc_snd_play_over(snd_menu_accept);
                    submenu = 0;
