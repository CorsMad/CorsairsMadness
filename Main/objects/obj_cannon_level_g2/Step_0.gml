...
//place_meeting(x,y,obj_Player) && talk_cr_t = 0 && obj_Player.isDead !=2 && obj_Player.key_up_press && obj_Player.isGrounded = 1 && obj_Player.isAttacking = 0 && obj_Player.isDashing = 0 && obj_Player.isAttackingdown = 0 && obj_Player.isAirattacking = 0 && obj_Player.isUsingitem = 0
    {
        talk = 1;
        obj_Player.isDead = 2;
...
if talk_cr_t!= 0 
{
    ...
    if talk_cr_t = 10
    {
        instance_create_depth(camera_get_view_x(view_camera[0]),0,-10000,obj_cannon_level_g2_menu);
        talk_cr_t = 0;   
    }
}
#endregion
...
if pjump = 1
{
      if instance_exists(obj_Player)
      {
            ...
            if obj_Player.vspd >=0 
            {
                ...
                obj_Player.depth = obj_cannon_level_g2.depth+2;
            }
