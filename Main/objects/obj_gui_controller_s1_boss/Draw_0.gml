...
#region enemy_hp
	...
	if instance_exists(obj_boss_s1_phase1)
	{
		for (var i=1; i-1<obj_boss_s1_phase1.enemy_hp; i++) 
		{
	...
	#region phase 2
	if instance_exists(obj_boss_s1_phase2_1)
	{
		for (var i=1; i-1<obj_boss_s1_phase2_1.enemy_hp; i++) 
		{
	...
	if instance_exists(obj_boss_s1_phase2_2)
	{
	...
	#region phase3
	if instance_exists(obj_boss_s1_phase3_1)
	{
		for (var i=1; i-1<obj_boss_s1_phase3_1.enemy_hp; i++) 
		{
	...
	if instance_exists(obj_boss_s1_phase3_2)
	{
		for (var i=1; i-1<obj_boss_s1_phase3_2.enemy_hp; i++) 
		{
	...
	if instance_exists(obj_boss_s1_phase3_3)
	{
		for (var i=1; i-1<obj_boss_s1_phase3_3.enemy_hp; i++) 
		{
	...
	if instance_exists(obj_boss_s1_phase3_4)
	{
		for (var i=1; i-1<obj_boss_s1_phase3_4.enemy_hp; i++) 
		{
