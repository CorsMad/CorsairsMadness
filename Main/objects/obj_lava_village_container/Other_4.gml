...
if global.dia_lavaChief = 0 || global.dia_lavaComt > 0
{
...
{
    instance_create_depth(320,160,10,obj_npc_village_pointer);
}

if instance_exists(obj_npc_lavav_comt) && global.dia_lavaComt > 0 
{
    instance_create_depth(544,144,10,obj_npc_village_pointer)   ;
}
#endregion