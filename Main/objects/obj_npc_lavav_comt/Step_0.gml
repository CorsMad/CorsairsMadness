...
switch(t_state)
{
    case 0:
        ...
        switch(t_anim)
        {
            ...
            case 150:   
                if image_xscale = 1 {
                    var boom = instance_create_depth(x,y-16,depth,obj_npc_lavav_comt_boom);
                    boom.hspd = -4;
                } 
                if image_xscale = -1
                {
...
{
	if place_meeting(x,y,obj_Player) && talk_cr_t = 0 && obj_Player.canTalk = 1 && global.dia_lavaComt != 0
