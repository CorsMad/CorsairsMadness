...
if sprImage !=noone
{
    if spr_timer1 = spr_timer_max1
    {
        draw_sprite_ext(sprImage,4,x+(62),y+18,1,1,0,c_white,1);
        draw_sprite_ext(sprImage,4,x+(78),y+18,1,1,0,c_white,1);
    }
    if spr_timer2 = spr_timer_max2
    {
        draw_sprite_ext(sprImage,3,x+(73),y+32,1,1,0,c_white,1);
    }
}