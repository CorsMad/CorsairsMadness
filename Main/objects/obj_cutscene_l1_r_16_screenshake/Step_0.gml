...
var bgr5 = layer_get_id("Tiles_3");
var bgr6 = layer_get_id("Tiles_2");
...
layer_x(bgr6, shake_x_4);
layer_y(bgr6, shake_y_4);
layer_x(bgr5, shake_x_3);
layer_y(bgr5, shake_y_3);
...
shake_y_2 = lerp(shake_y_2,1000,0.1);
...
if state = 1 {
   t++;
    if t = 10 
    {
        ...
        shake_y_2 = random_range(999,1001);
