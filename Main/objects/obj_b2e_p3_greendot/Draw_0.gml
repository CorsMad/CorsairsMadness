...
{
    if (obj_bossj2e_phase3.state = 4 && obj_bossj2e_phase3.t > 60) || (obj_bossj2e_phase3.state = 5 && obj_bossj2e_phase3.t < 30)
    {
        if alpha < 0.5 alpha +=0.1;
        var x_orig = obj_bossj2e_phase3.x;
        var y_orig = obj_bossj2e_phase3.y;
