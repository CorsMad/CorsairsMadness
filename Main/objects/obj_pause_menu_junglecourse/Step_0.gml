        ...
        case 0: // main menu
            switch(index)
            {
                case 0: 
                    ...
                    break;
                case 1: 
                    if instance_exists(obj_pause_controller_junglecourse) obj_pause_controller_junglecourse.isPaused = 0;
...
if keyboard_check_pressed(vk_escape) && KBControlChange = 0 {
	...
	switch(submenu){
		case 0:
			if instance_exists(obj_pause_controller_junglecourse) {obj_pause_controller_junglecourse.isPaused = 0;obj_pause_controller_junglecourse.delay = 3}
            instance_activate_all();
            instance_destroy();
			break;
		case 1:
