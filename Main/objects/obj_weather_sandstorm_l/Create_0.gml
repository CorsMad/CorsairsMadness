...
part_type_shape(partWind,pt_shape_pixel);
part_type_size(partWind,1.5,2.5,0,0);    //partRain,0.2,0.3,0,0
part_type_color2(partWind,c_yellow, c_white);
part_type_alpha2(partWind,.75,.95);
part_type_gravity(partWind,0.0,180);
part_type_speed(partWind,6,10,0,0);
part_type_direction(partWind,0,0,0,1);
part_type_orientation(partWind,0,0,0,0,0);
