...
scr_text_graphics();
draw_sprite(spr_text_icons,23,camera_get_view_x(view_camera[0])+6,camera_get_view_y(view_camera[0])+9);
...
switch(scr_t)
{
    case 0: text = text4;break;
    case 1: text = text5;break;
    case 2: text = text6;break;
    case 3: text = text7;break;
}