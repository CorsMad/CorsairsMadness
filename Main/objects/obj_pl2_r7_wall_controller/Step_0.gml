if state = 0 // Jumper redfly Berserker 
{
    t++;
    switch(t)
    {
        ...
        case 200:
            if instance_exists(obj_Player)
            {
                ...
                {
                    instance_create_depth(368,160,0,obj_molded_small_fastfly);
                }
            }        
            break;
        case 400:
            if instance_exists(obj_Player)
            {
                ...
                {
                    var e1 = instance_create_depth(320,192,0,obj_molded_big_spawner_n);
                    e1.y_cr = 16;
                    e1.obj_cr = obj_molded_lava_berserker;   
                    e1.state = 1;
                }
...
if state = 1 // Berserker redfly Berserker walkred Berserker 
{
    t++;
    switch(t)
    {
...
if state = 2 // Berserker redfly Berserker walkred Jumper
{
    t++;
    switch(t)
    {
