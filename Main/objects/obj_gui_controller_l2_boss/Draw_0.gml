...
#region enemy_hp
	if instance_exists(obj_boss_d2_phase1_controller)
	{
		for (var i=1; i-1<obj_boss_d2_phase1_controller.enemy_hp; i++) 
		{
	...
	if instance_exists(obj_boss_d2_phase2_controller)
	{
		for (var i=1; i-1<obj_boss_d2_phase2_controller.enemy_hp; i++) 
		{
			draw_sprite_ext(spr_hud_boss_hp,1,(camera_get_view_x(view_camera[0])+460)-i*9,camera_get_view_y(view_camera[0])+16,1,1,0, c_white,1);
		}
	}
	if instance_exists(obj_boss_d2_phase3_controller)
	{
		for (var i=1; i-1<obj_boss_d2_phase3_controller.enemy_hp; i++) 
		{
			draw_sprite_ext(spr_hud_boss_hp,1,(camera_get_view_x(view_camera[0])+460)-i*9,camera_get_view_y(view_camera[0])+16,1,1,0, c_white,1);
		}
	}
