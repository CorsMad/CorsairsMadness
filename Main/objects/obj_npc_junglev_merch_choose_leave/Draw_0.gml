...
if global.language = 1 draw_text(room_width/2,10,eng4); else draw_text(room_width/2,8,eng4);;
if global.language = 1 draw_text(room_width/2,46,eng3); else draw_text(room_width/2,44,eng3);;
...
switch(select)
{
    case 0: 
        ...
        switch(global.language){
            ...
            case 6:  _xsc = 9;break;   
            case 7:  _xsc = 6;break;   
            case 8:  _xsc = 13;break;   
            case 9:  _xsc = 11;break;   
            case 10: _xsc = 9;break;   
        }
        draw_sprite_ext(spr_text_9slicesmall_tp,0,camera_get_view_x(view_camera[0])+240,5+9,_xsc,1,0,c_white,1);
    ...
    case 1: 
        ...
        switch(global.language){
            ...
            case 8:  _xsc = 4;break;   
            case 9:  _xsc = 4;break;   
            case 10: _xsc = 3;break;   
        }
        draw_sprite_ext(spr_text_9slicesmall_tp,0,camera_get_view_x(view_camera[0])+240,5+45,_xsc,1,0,c_white,1);
...
#region skip
	...
	//draw_set_halign(fa_left) 
	draw_sprite_ext(spr_skip_frame,0,room_width/2-45,27,1,1,0,c_white,alpha_skip);
	draw_sprite_stretched_ext(spr_skip_line,0,room_width/2-45+5,27+5,(skip_t/skip_t_max)*80,8,c_white,alpha_skip);
#endregion
