...
if instance_exists(obj_Player)
{
    ...
    draw_sprite_ext(spr_text_9slicesmall,0,camera_get_view_x(view_camera[0])+240,52,10,2,0,c_white,alpha);
    ...
    switch(isKeyboard)
    {
        case 0: draw_sprite_ext(spr_gp_icon,1,x1 + 12, y1-8,1,1,0,c_white,alpha);
                draw_text_color(x1+34,y1-11,"/",c_white,c_white,c_white,c_white,alpha);
                draw_sprite_ext(spr_gp_icon,8,x1 + 50, y1-8,1,1,0,c_white,alpha); 
                break;
        case 1: draw_sprite_ext(spr_key_icon,scr_key_sprite(global.dash_key),x1 + 12, y1-8,1,1,0,c_white,alpha); break;
    }
