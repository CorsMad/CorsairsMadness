...
draw_sprite(spr_green_coin_choose,global.secrets_l2b_r5,camera_get_view_x(view_camera[0])+128,120);
draw_sprite(spr_green_coin_choose,global.secrets_l2p_s,camera_get_view_x(view_camera[0])+352,120);