...
draw_sprite(spr_green_coin_choose,global.secrets_d2b_s1,camera_get_view_x(view_camera[0])+128,120);
draw_sprite(spr_green_coin_choose,global.secrets_d2p_r4,camera_get_view_x(view_camera[0])+352,120);