...
switch(state)
{
    case 0:
        ...
        if t = 100
        {
            var ph1 = instance_create_depth(432,192,0,obj_boat_boss_vulcano_1_appear);
            ph1.boss_phase = obj_boat_boss_vulcano_1;
            t = 0;
            state = 1;
        }
        break;
    case 2:
        ...
        {
            var ph1 = instance_create_depth(432,192,0,obj_boat_boss_vulcano_1_appear);
            ph1.boss_phase = obj_boat_boss_vulcano_2;
            t = 0;
            state = 3;
        }
        break;
    ...
    case 4:
        ...
        {
            var ph1 = instance_create_depth(432,192,0,obj_boat_boss_vulcano_1_appear);
            ph1.boss_phase = obj_boat_boss_vulcano_3;
            t = 0;
            state = 5;
        }
        break;
