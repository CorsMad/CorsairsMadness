...
if place_meeting(x,y,obj_item_boomerang) && hit_cd = 0
{
	...
	hp -= 3;
    t_red = 1;
	instance_create_depth(x+382+random_range(-8,8),y+192+random_range(-8,8),depth-1,obj_sfx1)
	instance_create_depth(x+382+random_range(-8,8),y+192+random_range(-8,8),depth-1,obj_sfx2)
	instance_create_depth(x+382+random_range(-8,8),y+192+random_range(-8,8),depth-1,obj_sfx1)
}
if place_meeting(x,y,obj_hitbox) && hit_cd = 0
{
    ...
    t_red = 1;
	hp -= 1;
	instance_create_depth(x+382,y+192,depth-1,obj_sfx_weapon_slash)
}
