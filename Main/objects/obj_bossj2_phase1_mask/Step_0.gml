...
if enemy_hp <= 0
{
    ...
    var i = instance_create_depth(x,y,0,obj_bossj2_phase1_death);
    i.image_xscale = obj_bossj2_phase1.image_xscale;
    instance_destroy(obj_bossj2_phase1);
    instance_destroy();   
}


#region столкновение с пруж
