...
if state = 7
{
    if instance_exists(obj_boss_d2_phase2_up)
    {
        ...
        instance_create_depth(obj_boss_d2_phase2_up.x,obj_boss_d2_phase2_up.y,depth,obj_boss_d2_phase2_death);
    ...
    if instance_exists(obj_boss_d2_phase2_down_1)
    {
        ...
        instance_create_depth(obj_boss_d2_phase2_down_1.x,obj_boss_d2_phase2_down_1.y,depth,obj_boss_d2_phase2_death);
    ...
    if instance_exists(obj_boss_d2_phase2_down_2)
    {
        ...
        instance_create_depth(obj_boss_d2_phase2_down_2.x,obj_boss_d2_phase2_down_2.y,depth,obj_boss_d2_phase2_death);
