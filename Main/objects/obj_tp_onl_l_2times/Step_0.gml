...
if (dc2 >= 2 && isOn != 12 && isOn != 11)
{
    isOn = 2;   
} else  if (dc1 >= 2 && isOn != 11 && isOn != 12)
        {
            isOn = 1;   
        }
...
if isOn = 1
{
    if instance_exists(obj_Player) && place_meeting(x,y,obj_Player) && obj_Player.isGrounded = 1 && obj_Player.isDashing = 0 && obj_Player.isAttacking = 0 && obj_Player.isAirattacking = 0 && obj_Player.isAttackingdown = 0
    {
        if obj_Player.key_up
        {
            ...
            fnc_snd_play_over(snd_teleport_start);
        }
    }
}
...
switch(isOn)
{
    ...
    case 2: sprite_index = spr_teleport2;break;
    case 11:sprite_index = spr_teleport1;break;
    case 12:sprite_index = spr_teleport2;break;
}
...
if (isOn = 1 || isOn = 2) && place_meeting(x,y,obj_Player) && obj_Player.isGrounded = 1
{
