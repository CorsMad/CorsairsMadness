...
switch(t_state)
{
    case 0:
        ...
        switch(t_anim)
        {
            ...
            case 150:   
                if image_xscale = 1 {
                    var boom = instance_create_depth(x,y-16,depth,obj_npc_lavac_comt2_boom);
                    boom.hspd = -4;
                } 
                if image_xscale = -1
                {
...
if talk_cr_t!= 0 
{
    ...
    if talk_cr_t = 10
    {
        ...
        if talked = 0
        {
            ...
            instance_create_depth(x,y,-100000,obj_txt_lavac_comt2); //3 разговор 
        }
        if talked = 1
        {
            instance_create_depth(x,y,-100000,obj_npc_lavac_comt_choose);     
        }
