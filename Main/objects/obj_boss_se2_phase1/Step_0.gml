...
if (state = 1) { // 2 удара вперед с выпадом    
    ...
    switch(t)
    {
        ...
        case 45: 
            image_index = 5;
            var hitbox = instance_create_depth(x,y,depth,obj_boss_se2_phase1_attack1_1);
            hitbox.image_xscale = image_xscale;
            break;   
        case 50: image_index = 6;break;   
        case 55: 
            instance_destroy(obj_boss_se2_phase1_attack1_1);
            image_index = 7;
            break;   
        case 60: image_index = 4;break;   
        case 100: 
            if obj_Player.x < x hspd = -2 else hspd = 2;
            var hitbox2 = instance_create_depth(x,y,depth,obj_boss_se2_phase1_attack1_2);
        ...
        case 130: 
            instance_destroy(obj_boss_se2_phase1_attack1_2);
            hspd = 0;
            image_index = 4;
            break;
        case 140:
...
if (state = 2) { // размашистый удар
    ...
    switch(t)
    {
        ...
        case 35:    
            var hitboxup = instance_create_depth(x,y,depth,obj_boss_se2_phase1_attack2);
        ...
        case 50:    
        image_index = 5;
        instance_destroy(obj_boss_se2_phase1_attack2);
        break;   
        case 70:    
            t = 0;
            state = 3;
...
if enemy_hp <=0 
{
    var d = instance_create_depth(x,y,depth,obj_boss_se2_phase1_death);
