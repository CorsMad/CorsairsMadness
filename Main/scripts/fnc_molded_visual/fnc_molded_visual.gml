...
function fnc_molded_green_blood_hit(){
    ...
    var gbh3 = instance_create_depth(x,y-8,depth+0.1,obj_molded_green_blood);
    var gbh4 = instance_create_depth(x,y-8,depth+0.1,obj_molded_green_blood);
    if obj_Player.x >= x
    {
        var dest = -1;
    } else var dest = 1;
    
    gbh1.hspd = dest*choose(0.2,0.25,0.3,0.35);
    gbh1.vspd = -3;
    
    gbh2.hspd = dest*choose(0.7,0.75,0.7,0.75);
    gbh2.vspd = -2.75;
    
    gbh3.hspd = dest*choose(0.85,0.9,1,1.25);
    gbh3.vspd = -2.5;
    
    gbh4.hspd = dest*choose(1.65,1.7,1.75,1.8);
    gbh4.vspd = -2.25;
}
...
function fnc_molded_green_blood_forward(){
    ...
    var gbf3 = instance_create_depth(x,y-8,depth+0.1,obj_molded_green_blood);
    var gbf4 = instance_create_depth(x,y-8,depth+0.1,obj_molded_green_blood);
    if obj_Player.x >= x
    {
        var dest = -1;
    } else var dest = 1;
    
    gbf1.hspd = dest*choose(6);
    gbf1.vspd = -2.75;
    gbf1.grav = 0.1;
    
    gbf2.hspd = dest*choose(5.75);
    gbf2.vspd = -2.5;
    gbf2.grav = 0.111;
    
    gbf3.hspd = dest*choose(5.5);
    gbf3.vspd = -2.25;
    gbf3.grav = 0.112;
      
    gbf4.hspd = dest*choose(5.25);
    gbf4.vspd = -2.25;
    gbf4.grav = 0.113;
...
function fnc_molded_green_blood_up(){
    ...
    var gbu3 = instance_create_depth(x,y-8,depth+0.1,obj_molded_green_blood);
    var gbu4 = instance_create_depth(x,y-8,depth+0.1,obj_molded_green_blood);
    if obj_Player.x >= x
    {
        var dest = -1;
    } else var dest = 1;
    
    gbu1.hspd = dest*choose(0.1);
    gbu1.vspd = -6;
    gbu1.grav = 0.11;

    
    gbu2.hspd = dest*choose(0.25);
    gbu2.vspd = -5.9;
    gbu2.grav = 0.12;

    
    gbu3.hspd = dest*choose(0.35);
    gbu3.vspd = -5.8;
    gbu3.grav = 0.13;

      
    gbu4.hspd = dest*choose(0.45);
    gbu4.vspd = -5.8;
    gbu4.grav = 0.15;
...
function fnc_molded_green_blood_down(){
    ...
    var gbd3 = instance_create_depth(x,y-8,depth+0.1,obj_molded_green_blood);
    var gbd4 = instance_create_depth(x,y-8,depth+0.1,obj_molded_green_blood);
    if obj_Player.x >= x
    {
        var dest = -1;
    } else var dest = 1;
    
    gbd1.hspd = dest*choose(2);
    gbd1.vspd = 1;
    gbd1.grav = 0.2;

    
    gbd2.hspd = dest*choose(1);
    gbd2.vspd = 1;
    gbd2.grav = 0.12;

    
    gbd3.hspd = dest*choose(0.5);
    gbd3.vspd = 1;
    gbd3.grav = 0.13;

      
    gbd4.hspd = dest*choose(0);
    gbd4.vspd = 1;
    gbd4.grav = 0.15;
