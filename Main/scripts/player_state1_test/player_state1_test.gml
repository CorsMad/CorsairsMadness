...
if jumpbuffer = 1 && isRecoil = 0 && isAirThrowingBomb = 0 && isAfterhook = 0 && isThrowingBomb = 0 &&  isUsingitem = 0 && isAttacking = 0 && isDashing = 0 && isWallclimbing = 0 && isOutjump = 0 && isClimbing = 0 && isHooking = 0 && coyote_timer!=0 && isTakingdmg = 0 && isPickup = 0
{
    audio_play_sound(snd_player_jump,0,0);
	jump_timer+=1;
	vspd = -6;	
...
#region Hooking
    #region Hooking
        if HookEnabled = 1 && key_item && hooking_timer_count = 0 && !instance_exists(obj_item_hook_masked) && isAfterhook = 0 && isAttacking = 0 && isAirattacking = 0 && isDashing = 0 && isRecoil = 0 && isTakingdmg = 0 && (hook_iframes_timer > 15 || hook_iframes_timer = 0)
        {
