...
#macro SCRIBBLE_DEFAULT_WAVE_SIZE           1        // 4   Default wave amplitude, in pixels
#macro SCRIBBLE_DEFAULT_WAVE_FREQUENCY      50       // 50  Default wave frequency. Larger values create more "humps" over a certain number of characters
#macro SCRIBBLE_DEFAULT_WAVE_SPEED          0.2      // 0.2 Default wave speed. Larger numbers cause characters to move up and down more rapidly

#macro SCRIBBLE_DEFAULT_SHAKE_SIZE          1        //Default shake amplitude, in pixels 2
#macro SCRIBBLE_DEFAULT_SHAKE_SPEED         0.4      //Default shake speed. Larger values cause characters to move around more rapidly 0.4
